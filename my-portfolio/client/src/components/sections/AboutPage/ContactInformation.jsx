  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto text-center">
        ...
        <p className="text-gray-600">Address-1: Nagavara,Near Manyata Tech Park, Bangalore, India</p>
        <p className="text-gray-600">Address-2: Jaipur,Rajasthan, India</p>
        <p className="text-gray-600">Address-3: Noida,Sector 16, Uttarpradesh, India</p>
      </div>
    </section>
  );
};
