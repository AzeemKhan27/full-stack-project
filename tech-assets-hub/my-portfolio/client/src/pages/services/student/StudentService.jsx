...
const StudentService = () => {
  ...
  const courseCategories = [
    { title: 'IT/CS', items: ['Web Development in MERN', 'Android App Development: Build Native Applications', 'React Native Development: Build Native Cross-Platform Mobile Apps', 'Full-Stack .NET Development', 'Python Training', 'DevOps', 'SEO/Digital Marketing', 'DSA', 'System Design'] },
